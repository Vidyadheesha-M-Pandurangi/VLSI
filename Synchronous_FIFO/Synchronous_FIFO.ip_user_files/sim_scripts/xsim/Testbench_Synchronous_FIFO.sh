...
#
# Script generated by Vivado on Mon May 12 16:32:34 +0530 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : Testbench_Synchronous_FIFO.sh
...
#
# Usage        : Testbench_Synchronous_FIFO.sh
#                Testbench_Synchronous_FIFO.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Testbench_Synchronous_FIFO.sh [-reset_run]
#                Testbench_Synchronous_FIFO.sh [-reset_log]
#                Testbench_Synchronous_FIFO.sh [-help]
#
...
# script info
echo -e "Testbench_Synchronous_FIFO.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Testbench_Synchronous_FIFO.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip --snapshot Testbench_Synchronous_FIFO xil_defaultlib.Testbench_Synchronous_FIFO xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Testbench_Synchronous_FIFO -key {Behavioral:sim_1:Functional:Testbench_Synchronous_FIFO} -tclbatch cmd.tcl -protoinst "protoinst_files/Block_Diagram.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Vivado/2024.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Testbench_Synchronous_FIFO.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Testbench_Synchronous_FIFO.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: Testbench_Synchronous_FIFO.sh [-help]\n\
Usage: Testbench_Synchronous_FIFO.sh [-step]\n\
Usage: Testbench_Synchronous_FIFO.sh [-lib_map_path]\n\
Usage: Testbench_Synchronous_FIFO.sh [-reset_run]\n\
Usage: Testbench_Synchronous_FIFO.sh [-reset_log]\n\
Usage: Testbench_Synchronous_FIFO.sh [-keep_index]\n\
Usage: Testbench_Synchronous_FIFO.sh [-noclean_files]\n\n\
